        ...
        <Fade left>
          <div className="cta">
            ...
            <div className="cta-body">
              <p>I'm a full stack developer working on cool projects with outstanding people. In my spare time, when I can find some, I like to explore new places and document it via photography. See some of my work, skills and photos below.</p>
